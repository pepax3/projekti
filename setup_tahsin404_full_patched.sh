...
log "Patching suckless color header includes to local repo files"

sed -i 's|#include "/home/xelius/.cache/wal/colors-wal-dwm.h"|#include "colors-wal-dwm.h"|g' "$REPO_DIR/dwm/config.h" || true
sed -i 's|#include "/home/p/.cache/wal/colors-wal-dwm.h"|#include "colors-wal-dwm.h"|g' "$REPO_DIR/dwm/config.h" || true

sed -i 's|#include "/home/xelius/.cache/wal/colors-wal-st.h"|#include "colors-wal-st.h"|g' "$REPO_DIR/st/config.h" || true
sed -i 's|#include "/home/p/.cache/wal/colors-wal-st.h"|#include "colors-wal-st.h"|g' "$REPO_DIR/st/config.h" || true

sed -i 's|#include "/home/xelius/.cache/wal/colors-wal-dmenu.h"|#include "colors-wal-dmenu.h"|g' "$REPO_DIR/dmenu/config.h" || true
sed -i 's|#include "/home/p/.cache/wal/colors-wal-dmenu.h"|#include "colors-wal-dmenu.h"|g' "$REPO_DIR/dmenu/config.h" || true

cp -f "$REPO_DIR/colors-wal-dwm.h" "$REPO_DIR/dwm/colors-wal-dwm.h"
cp -f "$REPO_DIR/colors-wal-st.h" "$REPO_DIR/st/colors-wal-st.h"
cp -f "$REPO_DIR/colors-wal-dmenu.h" "$REPO_DIR/dmenu/colors-wal-dmenu.h"
